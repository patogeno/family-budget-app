...
BANK_FORMATS = json.loads(os.getenv('BANK_FORMATS'))
...
# Include budget app in the list of installed apps
INSTALLED_APPS = [
...
CORS_ALLOW_ALL_ORIGINS = False  # To be removed for production
CORS_ALLOW_METHODS = [
    'DELETE',
    'GET',
    'OPTIONS',
...
SWAGGER_SETTINGS = {
    ...
    'VALIDATOR_URL': None,
    'DEFAULT_INFO': 'family_budget.urls.swagger_info',
}